...
if [[ "${RAM_ALLOW_AD_HOC_BUILD:-0}" == "1" ]]; then
    print -u2 "Release packaging does not allow an ad hoc app signature."
    exit 1
fi
...
print "Archive: dist/${archive_path:t}"
print "Checksum: dist/${checksum_path:t}"
print "Signature: dist/${signature_path:t}"
