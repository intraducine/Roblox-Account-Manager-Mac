...
- Keep v1.1.1 marked as GitHub's latest release during the signing transition. After the bridge period, promote v1.1.2 or the current final release to latest. Updated clients compare all final releases by version.
